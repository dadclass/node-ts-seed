...
var App = /** @class */ (function () {
    ...
    App.prototype.buildPath = function (filename) {
        return path_1.default.join(__dirname, "../" + filename);
    };
    App.prototype.getProjectName = function () {
        var projectRootPath = process.cwd();
        return projectRootPath.substring(projectRootPath.lastIndexOf(path_1.default.sep) + 1);
    };
    App.prototype.capWords = function (str) {
        return str
            .toLowerCase()
            .split("-")
            .map(function (word) {
    ...
    App.prototype.initFile = function (fileName, rxSearch, strReplace) {
        return __awaiter(this, void 0, void 0, function () {
            var filePath, data, replaced, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        data = _a.sent();
                        replaced = this.resetProject(fileName, data, rxSearch, strReplace);
                        return [4 /*yield*/, this.WRITE(filePath, replaced)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.READ(filePath, "utf8")];
                    case 4:
